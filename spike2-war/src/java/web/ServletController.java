...
public class ServletController extends HttpServlet {
    @EJB
    private GestorelibroLocal gestorelibro;
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (action.equals("register")) {
                ...
                if (action.equals("addBook")) {
                    ...
                    //  l.setTitolo(ti);
                    gestorelibro.aggiungiLibro(ti, au);

                } else {
                    System.out.println("Action OTHER");
                }
            }
            List<Libro> lista = gestorelibro.getLibro();
...
//            }
    ...
    private String buildGson(List<Libro> l) {
        ...
        if (json == null) {
            System.out.println("servlet of buildGson: NULL");
        } else {
            System.out.println("servlet of  buildGson: NOT NULL  " + json);
        }
        return json;
    }
